...
public class Data {
	public static final StatsDto stats_001 = new StatsDto(0.0,.0,.0); 
	...
	public static final List<String> dna_human_error = Arrays.asList("ATGVCGA","CAGTGC","TTYATTT","AGACGR","GCXTCA","TCACTT");
	public static final HumanDto humanDto_error = new HumanDto(dna_human_error); 
