...
public class MagnetoCrypto {
	static BCryptPasswordEncoder bCryptPasswordEncoder = new BCryptPasswordEncoder(12);

	public static String Enrcrypt(String plainText, String secretKey) {
	...
	public static String BCrypt(String plainText) {
		String encryptPassword = bCryptPasswordEncoder.encode(plainText);
